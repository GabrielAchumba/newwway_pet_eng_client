            ...
            <template v-slot:body="props">
                <q-tr>
                    ...
                    <q-td 
                        ...
                        :options="props.row?.columsOptions?.[column.name]"
                        :model-value="props.row[column.name]"
                        option-value="id"
                        option-label="type"
                        name="type"
                        ...
                        <template v-slot:append>
                            <q-icon
                            name="palette"
                            :style="{ color: props.row[column.name] }"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const updateProperty = (row, column, value) => {
        ...
        // Find the row index and update the specific property
    ...
    const pickColor = (row, column) => {
        colorDialog.value.visible = true
        colorDialog.value.row = row
        colorDialog.value.column = column
        colorDialog.value.tempValue = row[column.name]
    }
    ...
    const pickDate = (row, column) => {
        ...
        dateDialog.value.row = row
        dateDialog.value.column = column
        dateDialog.value.tempValue = row[column.name]
    }
