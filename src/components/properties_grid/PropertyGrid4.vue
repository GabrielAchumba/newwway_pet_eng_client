...
const categories = ref([
  {
    name: 'General',
    properties: [
      { name: 'Title', type: 'text', value: 'My Application', default: 'My Application' },
      { name: 'Version', type: 'text', value: '1.0.0', default: '1.0.0' },
      { name: 'Author', type: 'text', value: 'Gabriel Achumba', default: 'Gabriel Achumba' }
    ]
  },
  {
    name: 'Appearance',
    properties: [
      { name: 'Theme', type: 'select', value: 'Light', options: ['Light', 'Dark', 'System'], default: 'Light' },
      { name: 'Primary Color', type: 'color', value: '#1976D2', default: '#1976D2' },
      { name: 'Font Size', type: 'number', value: 14, default: 14 }
    ]
  },
  {
    name: 'Advanced',
    properties: [
      { name: 'Enable Logs', type: 'boolean', value: true, default: true },
      { name: 'Max Connections', type: 'number', value: 100, default: 100 },
      { name: 'Launch Date', type: 'date', value: '2025-08-12', default: '2025-08-12' }
    ]
  }
])
