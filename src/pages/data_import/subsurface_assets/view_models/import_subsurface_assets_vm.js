...
export const dialogsWellsImport = [
    { title: "Import Subsurface Asset Names", isVisible: false, message: "Do you want to import subsurface asset names",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
    { title: "Success", isVisible: false, message: "Subsurface asset names imported successfully!",
    okayEvent: "okDialog", cancelEvent: "cancelDialog" },
